...
contract Neko is IERC721 {
    ...
    string internal nftName = "NEKO";
    string internal nftSymbol = "NEKO";
    ...
    function tokenURI(uint256 _tokenId) external view validNFToken(_tokenId) returns (string memory) {
        return string(abi.encodePacked("https://manekin-neko.herokuapp.com/api/token/", toString(_tokenId)));
    }
